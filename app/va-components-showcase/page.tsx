        ...
        <div className="container mx-auto px-4 py-3">
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-4">
              ...
              <h1 className="text-xl font-semibold">VA Components Showcase</h1>
            </div>
          </div>
        </div>
      </div>
              ...
              <div className="vads-l-grid-container">
                <div className="vads-l-row">
                  <div className="vads-l-col--12">
                    <h1 className="vads-u-font-size--h1 vads-u-margin-bottom--2">VA Design System Components</h1>
                    <p className="va-introtext">
                      This page showcases various components from the official VA Design System that you can use in your
                      prototypes.
                    </p>
